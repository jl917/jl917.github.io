...
각 기법을 바로 복사해서 써볼 수 있는 프롬프트 모음입니다. 기법의 개념과 언제 쓰는지는 [프롬프트 엔지니어링](./01-promptengineering)에 정리해 두었습니다.
...
- 아래 샘플은 형식만 흉내 냅니다. 실제로 도구를 실행하려면 [Function Calling](/ai/05-agent/03-function-calling)이 필요합니다.
...
- 자료를 자동으로 검색해 붙이는 구조는 [RAG 개요](/ai/04-rag/01-rag), 실전 템플릿은 [RAG 프롬프트](./03-rag)에 있습니다.
